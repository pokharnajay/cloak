          ...
          <div className="flex gap-1.5">
            {sessionId && (
              <button
                ...
                className="text-[11px] font-medium px-3 py-1.5 rounded-full transition-colors cursor-default flex items-center gap-1.5"
                style={{
            ...
            <button
              onClick={onDismiss}
              className="text-[11px] font-medium px-3 py-1.5 rounded-full transition-colors cursor-default"
              style={{
