...
import {
  Trash, Cpu, CurrencyDollar, Question, HardDrives, Sparkle, FolderOpen, Clock, Gear,
...
export const SLASH_COMMANDS: SlashCommand[] = [
  ...
  { command: '/project', description: 'Change working directory', icon: <FolderOpen size={13} /> },
  { command: '/history', description: 'Browse previous sessions', icon: <Clock size={13} /> },
]
