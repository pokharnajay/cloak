  ...
  return (
    <>
      ...
      {popoverLayer && open && createPortal(
        ...
        >
          <div className="flex-shrink-0" style={{ borderBottom: `1px solid ${colors.popoverBorder}` }}>
            <div className="px-3 py-2 text-[11px] font-medium" style={{ color: colors.textTertiary }}>
              Recent Sessions
            </div>
            <div className="px-2 pb-2">
              <div className="flex items-center gap-1.5 px-2 py-1 rounded-md" style={{ background: colors.surfaceHover }}>
                ...
                <input
                  ...
                  style={{ color: colors.textPrimary, border: 'none' }}
                />
              </div>
            </div>
          </div>
          ...
          <div className="overflow-y-auto py-1" style={{ maxHeight: pos.maxHeight != null ? undefined : 180 }}>
            ...
            {!loading && filteredSessions.length === 0 && (
              <div className="px-3 py-4 text-center text-[11px]" style={{ color: colors.textTertiary }}>
                {searchQuery ? 'No matching sessions' : 'No previous sessions found'}
              </div>
            )}
